...
/***************----- 端口数据缓冲区 -----***************/
extern unsigned char Rx_Buffer[100];	//端口接收数据缓冲区 
extern unsigned char Tx_Buffer[100];	//端口发送数据缓冲区 

extern unsigned char Rx_size;
extern unsigned char Tx_size;


extern unsigned char W5500_Interrupt;	//W5500中断标志(0:无中断,1:有中断)
extern unsigned char TCP_Client_Con;
